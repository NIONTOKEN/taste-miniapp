...
const resources = {
    "en": {
        "translation": {
            "drawer": { "ai_chef_menu": "TASTE AI Chef (Recipe & Calories)", "ecosystem": "Ecosystem", "socials": "Socials", "team": "Team", "jobs": "Jobs", "swap": "Swap", "tokenomics": "Tokenomics", "whitepaper": "Whitepaper", "blockchain": "Blockchain", "ai": "AI", "ai_chef": "AI Chef", "help": "Help", "website": "Website", "legal": "Legal", "settings": "Settings" },
            ...
            "chef_banner": {
                ...
                "desc": "Pick fridge ingredients, get gourmet recipes & calories!",
                "start": "START"
            },
            "chef_app": {
                "fridge_title": "My Fridge & Selected",
                "clear": "Clear",
                "empty_hint": "No ingredients selected. Pick from below or type custom ones.",
                "custom_placeholder": "+ Type custom ingredient (e.g. Avocado, Salmon)...",
                "add": "Add",
                "quick_presets": "Quick Ingredient Presets",
                "chef_preferences": "Chef Preferences",
                "cooking_time": "Cooking Time",
                "diet_type": "Diet & Nutrition",
                "cuisine": "Cuisine Style",
                "create_recipe_btn": "✨ Generate Gourmet Recipe & Calories",
                "generating": "👨‍🍳 Chef is analyzing ingredients & calculating calories...",
                "macro_dashboard": "Macro & Calories (Per Serving)",
                "ingredients_title": "Required Ingredients & Measurements",
                "instructions_title": "Step-by-Step Preparation",
                "chef_tip_title": "👨‍🍳 Chef's Golden Secret (Pro Tip)",
                "new_recipe_btn": "🔄 Create New Recipe",
                "copied": "Copied!",
                "time_quick": "15-20 Min (Quick)",
                "time_medium": "30 Min (Medium)",
                "time_gourmet": "45+ Min (Gourmet)",
                "diet_all": "All / Standard",
                "diet_high_protein": "High Protein",
                "diet_low_calorie": "Low Calorie / Fit",
                "diet_keto": "Keto",
                "diet_vegan": "Vegan",
                "cuisine_mediterranean": "Mediterranean",
                "cuisine_turkish": "Turkish Cuisine",
                "cuisine_italian": "Italian",
                "cuisine_asian": "Asian",
                "cuisine_world": "World Cuisine",
                "calories": "Calories",
                "protein": "Protein",
                "carbs": "Carbs",
                "fat": "Fat",
            ...
            "profile_ext": { "title": "Profile", "your_level": "Your Level", "tai_balance": "TAI Balance", "total_withdrawal": "Total Withdrawal", "subscription": "Your Subscription", "free": "FREE", "free_desc": "Can withdraw TAI & earn rewards", "upgrade": "Upgrade", "privacy": "Privacy Policy", "logout": "Sign Out", "next_level": "Next:", "member_since": "Member since:", "level_apprentice": "Apprentice", "level_journeyman": "Journeyman", "level_master": "Master", "level_chef": "Chef", "level_head_chef": "Head Chef" },
            "swap_screen": { "title": "⚡ Buy TAI", "subtitle": "Earn TAI by swapping tokens", "select_pair": "Select Trading Pair", "sell_token": "Sell Token", "buy_token": "Buy Token", "trade_on": "Trade on", "swap_info": "💡 Swap happens on an external DEX. Connect your wallet and confirm.", "swap_btn": "{from} buy TAI — {dex}", "external_redirect": "This transaction redirects you to an external platform" },
            "kyc_ext": { "title": "Identity Verification (KYC)", "subtitle": "Verification is done through Telegram.", "verify_telegram": "Verify via Telegram", "verify_telegram_desc": "Start the process by messaging our official account", "verify_btn": "Verify with Telegram →", "pending_title": "Verification pending", "stay_telegram": "Stay in contact via Telegram", "close": "Close" },
            "app_ext": { "powered_by": "Powered by Taste AI", "new_badge": "NEW", "settings_label": "Settings" },
            "coin_details": {"live_price": "Live Price", "trade": "Trade on Exchange", "send": "Send", "deposit": "Deposit", "stats": "Market & Technical Info", "contract": "Contract Address (Jetton)", "view_chart": "Chart"},
            "manage_coins": {"title": "🪙 Manage Assets / Add Coin", "tab_manage": "Manage & Hide Coins", "tab_add": "Add Custom Coin", "hide_hint": "You can hide coins you don't want to see on your wallet home screen.", "hidden": "Hidden", "shown": "Visible", "add_desc": "Paste the TON Jetton contract (master) address you want to add:", "search": "Find", "invalid_addr": "Please enter a valid TON Jetton contract address.", "confirm_add": "Add to Wallet", "add_btn": "Add / Manage Coins"}
        }
    },
    "tr": {
        "translation": {
            "drawer": { "ai_chef_menu": "TASTE AI Şef (Tarif & Kalori)", "ecosystem": "Ekosistem", "socials": "Sosyal Medya", "team": "Takım", "jobs": "İş İlanları", "swap": "Takas", "tokenomics": "Tokenomi", "whitepaper": "Whitepaper", "blockchain": "Blokzincir", "ai": "Yapay Zeka", "ai_chef": "AI Şef", "help": "Yardım", "website": "Web Sitesi", "legal": "Yasal", "settings": "Ayarlar" },
            ...
            "chef_banner": {
                "title": "TASTE AI Şef",
                "new_badge": "YENİ",
                "new_engine": "YENİ MOTOR",
                "desc": "Buzdolabındaki malzemeleri seç, gurme tarif & kalori çıkar!",
                "start": "BAŞLA"
            },
            "chef_app": {
                "fridge_title": "Buzdolabım & Seçilenler",
                "clear": "Temizle",
                "empty_hint": "Henüz malzeme seçmediniz. Aşağıdaki listelerden ekleyin veya yazın.",
                "custom_placeholder": "+ Farklı bir malzeme yaz (örn: Avokado, Somon)...",
                "add": "Ekle",
                "quick_presets": "Hızlı Malzeme Seçimi",
                "chef_preferences": "Şef Tercihleri",
                "cooking_time": "Pişirme Süresi",
                "diet_type": "Diyet & Beslenme",
                "cuisine": "Mutfak Stili",
                "create_recipe_btn": "✨ Özel Gurme Tarif & Kalori Çıkar",
                "generating": "👨‍🍳 Şef malzemeleri değerlendiriyor & kalori hesaplıyor...",
                "macro_dashboard": "Makro & Kalori Değerleri (Porsiyon Başına)",
                "ingredients_title": "Gerekli Malzemeler & Ölçüler",
                "instructions_title": "Adım Adım Hazırlanışı",
                "chef_tip_title": "👨‍🍳 Şefin Altın Sırrı (Pro Tip)",
                "new_recipe_btn": "🔄 Yeni Tarif Oluştur",
                "copied": "Kopyalandı!",
                "time_quick": "15-20 Dk (Hızlı)",
                "time_medium": "30 Dk (Orta)",
                "time_gourmet": "45+ Dk (Gurme)",
                "diet_all": "Tümü / Standart",
                "diet_high_protein": "Yüksek Protein",
                "diet_low_calorie": "Düşük Kalori / Fit",
                "diet_keto": "Keto",
                "diet_vegan": "Vegan",
                "cuisine_mediterranean": "Akdeniz Mutfağı",
                "cuisine_turkish": "Türk Mutfağı",
                "cuisine_italian": "İtalyan Mutfağı",
                "cuisine_asian": "Asya Mutfağı",
                "cuisine_world": "Dünya Mutfağı",
                "calories": "Kalori",
                "protein": "Protein",
                "carbs": "Karbonhidrat",
                "fat": "Yağ",
            ...
            "profile_ext": { "title": "Profil", "your_level": "Seviyeniz", "tai_balance": "TAI Bakiye", "total_withdrawal": "Toplam Çekim", "subscription": "Aboneliğiniz", "free": "ÜCRETSİZ", "free_desc": "TAI çekebilir ve ödül kazanabilirsiniz", "upgrade": "Yükselt", "privacy": "Gizlilik Politikası", "logout": "Çıkış Yap", "next_level": "Sonraki:", "member_since": "Üye olma tarihi:", "level_apprentice": "Çırak", "level_journeyman": "Kalfa", "level_master": "Usta", "level_chef": "Şef", "level_head_chef": "Baş Şef" },
            "swap_screen": { "title": "⚡ TAI Satın Al", "subtitle": "Token değiştirerek TAI kazan", "select_pair": "İşlem Çifti Seç", "sell_token": "Satış token", "buy_token": "Alış token", "trade_on": "İşlem Yeri", "swap_info": "💡 Swap işlemi harici DEX üzerinden gerçekleşir. Cüzdanınızı bağlayın ve onaylayın.", "swap_btn": "{from} ile TAI Al — {dex}", "external_redirect": "Bu işlem sizi harici bir platforma yönlendirir" },
            "kyc_ext": { "title": "Kimlik Doğrulama (KYC)", "subtitle": "Doğrulama Telegram üzerinden yapılmaktadır.", "verify_telegram": "Telegram ile Doğrula", "verify_telegram_desc": "Resmi hesabımıza mesaj göndererek işlemi başlatın", "verify_btn": "Telegram ile Doğrula →", "pending_title": "Doğrulama bekleniyor", "stay_telegram": "Telegram üzerinden iletişimde kalın", "close": "Kapat" },
            "app_ext": { "powered_by": "Taste AI Tarafından Desteklenmektedir", "new_badge": "YENİ", "settings_label": "Ayarlar" },
            "coin_details": {"live_price": "Canlı Fiyat", "trade": "Borsada Al/Sat", "send": "Gönder", "deposit": "Yatır", "stats": "Piyasa & Teknik Bilgiler", "contract": "Kontrat Adresi (Jetton)", "view_chart": "Grafik"},
            "manage_coins": {"title": "🪙 Varlıkları Yönet / Coin Ekle", "tab_manage": "Coinleri Yönet & Gizle", "tab_add": "Özel Coin Ekle", "hide_hint": "Cüzdan ana sayfasında görünmesini istemediğiniz coinleri gizleyebilirsiniz.", "hidden": "Gizli", "shown": "Görünür", "add_desc": "Eklemek istediğiniz TON Jetton kontrat (master) adresini yapıştırın:", "search": "Bul", "invalid_addr": "Lütfen geçerli bir TON Jetton kontrat adresi girin.", "confirm_add": "Cüzdana Ekle", "add_btn": "Coin Ekle / Yönet"}
        }
    },
    "ru": {
        "translation": {
            "drawer": { "ai_chef_menu": "TASTE AI Шеф (Рецепты и калории)", "ecosystem": "Экосистема", "socials": "Соцсети", "team": "Команда", "jobs": "Вакансии", "swap": "Обмен", "tokenomics": "Токеномика", "whitepaper": "Whitepaper", "blockchain": "Блокчейн", "ai": "ИИ", "ai_chef": "ИИ Шеф", "help": "Помощь", "website": "Веб-сайт", "legal": "Правовая информация", "settings": "Настройки" },
            ...
            "chef_banner": {
                ...
                "desc": "Выберите ингредиенты из холодильника, получите рецепт и калории!",
                "start": "СТАРТ"
            },
            "chef_app": {
                "fridge_title": "Мой холодильник и выбранное",
                "clear": "Очистить",
                "empty_hint": "Ингредиенты не выбраны. Выберите ниже или введите свои.",
                "custom_placeholder": "+ Введите ингредиент (напр. Авокадо, Лосось)...",
                "add": "Добавить",
                "quick_presets": "Быстрый выбор продуктов",
                "chef_preferences": "Настройки шеф-повара",
                "cooking_time": "Время готовки",
                "diet_type": "Диета и питание",
                "cuisine": "Кулинарный стиль",
                "create_recipe_btn": "✨ Создать рецепт и рассчитать калории",
                "generating": "👨‍🍳 Шеф оценивает ингредиенты и считает калории...",
                "macro_dashboard": "БЖУ и калории (на порцию)",
                "ingredients_title": "Необходимые ингредиенты и пропорции",
                "instructions_title": "Пошаговое приготовление",
                "chef_tip_title": "👨‍🍳 Золотой совет шефа (Pro Tip)",
                "new_recipe_btn": "🔄 Создать новый рецепт",
                "copied": "Скопировано!",
                "time_quick": "15-20 мин (Быстро)",
                "time_medium": "30 мин (Средне)",
                "time_gourmet": "45+ мин (Гурме)",
                "diet_all": "Все / Стандарт",
                "diet_high_protein": "Высокий протеин",
                "diet_low_calorie": "Низкокалорийное / Фитнес",
                "diet_keto": "Кето",
                "diet_vegan": "Веган",
                "cuisine_mediterranean": "Средиземноморская",
                "cuisine_turkish": "Турецкая кухня",
                "cuisine_italian": "Итальянская",
                "cuisine_asian": "Азиатская",
                "cuisine_world": "Мировая кухня",
                "calories": "Калории",
                "protein": "Белки",
                "carbs": "Углеводы",
                "fat": "Жиры",
            ...
            "profile_ext": { "title": "Профиль", "your_level": "Ваш уровень", "tai_balance": "Баланс TAI", "total_withdrawal": "Всего выведено", "subscription": "Ваша подписка", "free": "БЕСПЛАТНО", "free_desc": "Можно выводить TAI и зарабатывать награды", "upgrade": "Улучшить", "privacy": "Политика конфиденциальности", "logout": "Выйти", "next_level": "Следующий:", "member_since": "Участник с:", "level_apprentice": "Ученик", "level_journeyman": "Подмастерье", "level_master": "Мастер", "level_chef": "Шеф", "level_head_chef": "Шеф-повар" },
            "swap_screen": { "title": "⚡ Купить TAI", "subtitle": "Зарабатывайте TAI, меняя токены", "select_pair": "Выберите торговую пару", "sell_token": "Продать токен", "buy_token": "Купить токен", "trade_on": "Торговать на", "swap_info": "💡 Обмен происходит на внешнем DEX. Подключите кошелёк и подтвердите.", "swap_btn": "{from} купить TAI — {dex}", "external_redirect": "Эта транзакция перенаправляет вас на внешнюю платформу" },
            "kyc_ext": { "title": "Верификация личности (KYC)", "subtitle": "Верификация осуществляется через Telegram.", "verify_telegram": "Верифицировать через Telegram", "verify_telegram_desc": "Начните процесс, написав нашему официальному аккаунту", "verify_btn": "Верифицировать через Telegram →", "pending_title": "Верификация в ожидании", "stay_telegram": "Оставайтесь на связи через Telegram", "close": "Закрыть" },
            "app_ext": { "powered_by": "Работает на Taste AI", "new_badge": "НОВОЕ", "settings_label": "Настройки" },
            "coin_details": {"live_price": "Текущая цена", "trade": "Торговать", "send": "Отправить", "deposit": "Пополнить", "stats": "Рыночная и тех. информация", "contract": "Адрес контракта (Jetton)", "view_chart": "График"},
            "manage_coins": {"title": "🪙 Управление активами / Добавить монету", "tab_manage": "Управление и скрытие монет", "tab_add": "Добавить токен", "hide_hint": "Вы можете скрыть монеты, которые не хотите видеть на главном экране.", "hidden": "Скрыто", "shown": "Видимо", "add_desc": "Вставьте адрес контракта (master) TON Jetton, который хотите добавить:", "search": "Найти", "invalid_addr": "Пожалуйста, введите корректный адрес контракта TON Jetton.", "confirm_add": "Добавить в кошелек", "add_btn": "Добавить / Управление"}
        }
    },
    "ar": {
        "translation": {
            "drawer": { "ai_chef": "AI الشيف", "ai_chef_menu": "TASTE AI الشيف (وصفات وسعرات)", "ecosystem": "النظام البيئي", "socials": "الشبكات الاجتماعية", "team": "الفريق", "jobs": "الوظائف", "swap": "تبديل", "tokenomics": "اقتصاد الرموز", "whitepaper": "الورقة البيضاء", "blockchain": "بلوكتشين", "ai": "الذكاء الاصطناعي", "help": "مساعدة", "website": "الموقع الإلكتروني", "legal": "قانوني", "settings": "الإعدادات" },
            ...
            "chef_banner": {
                "title": "TASTE AI الشيف",
                "new_badge": "جديد",
                "new_engine": "محرك جديد",
                "desc": "اختر مكونات الثلاجة، واحصل على وصفة ذواقة وسعرات حرارية!",
                "start": "ابدأ"
            },
            "chef_app": {
                "fridge_title": "ثلاجتي والمختارات",
                "clear": "مسح",
                "empty_hint": "لم يتم اختيار أي مكونات. اختر من الأسفل أو اكتب ما لديك.",
                "custom_placeholder": "+ أضف مكوناً مخصصاً (مثل: أفوكادو، سلمون)...",
                "add": "إضافة",
                "quick_presets": "اختيار سريع للمكونات",
                "chef_preferences": "تفضيلات الشيف",
                "cooking_time": "وقت الطهي",
                "diet_type": "النظام الغذائي",
                "cuisine": "نوع المطبخ",
                "create_recipe_btn": "✨ إنشاء وصفة ذواقة وحساب السعرات",
                "generating": "👨‍🍳 الشيف يحلل المكونات ويحسب السعرات...",
                "macro_dashboard": "القيم الغذائية والسعرات (لكل حصة)",
                "ingredients_title": "المكونات المطلوبة والكميات",
                "instructions_title": "خطوات التحضير بالتفصيل",
                "chef_tip_title": "👨‍🍳 سر الشيف الذهبي (نصيحة محترف)",
                "new_recipe_btn": "🔄 إنشاء وصفة جديدة",
                "copied": "تم النسخ!",
                "time_quick": "15-20 دقيقة (سريع)",
                "time_medium": "30 دقيقة (متوسط)",
                "time_gourmet": "45+ دقيقة (ذواقة)",
                "diet_all": "الكل / قياسي",
                "diet_high_protein": "بروتين عالي",
                "diet_low_calorie": "قليل السعرات / رشاقة",
                "diet_keto": "كيتو",
                "diet_vegan": "نباتي",
                "cuisine_mediterranean": "مطبخ متوسطي",
                "cuisine_turkish": "مطبخ تركي",
                "cuisine_italian": "مطبخ إيطالي",
                "cuisine_asian": "مطبخ آسيوي",
                "cuisine_world": "مطبخ عالمي",
                "calories": "سعرات",
                "protein": "بروتين",
                "carbs": "كربوهيدرات",
                "fat": "دهون",
            ...
            "profile_ext": { "title": "الملف الشخصي", "your_level": "مستواك", "tai_balance": "رصيد TAI", "total_withdrawal": "إجمالي السحب", "subscription": "اشتراكك", "free": "مجاني", "free_desc": "يمكنك سحب TAI وكسب المكافآت", "upgrade": "ترقية", "privacy": "سياسة الخصوصية", "logout": "تسجيل الخروج", "next_level": "التالي:", "member_since": "عضو منذ:", "level_apprentice": "متدرب", "level_journeyman": "صانع", "level_master": "ماهر", "level_chef": "طاهٍ", "level_head_chef": "رئيس الطهاة" },
            "swap_screen": { "title": "⚡ شراء TAI", "subtitle": "اكسب TAI عن طريق تبادل الرموز", "select_pair": "اختر زوج التداول", "sell_token": "رمز البيع", "buy_token": "رمز الشراء", "trade_on": "تداول على", "swap_info": "💡 يتم التبادل على DEX خارجي. اتصل بمحفظتك وأكد.", "swap_btn": "{from} شراء TAI — {dex}", "external_redirect": "هذه المعاملة تعيد توجيهك إلى منصة خارجية" },
            "kyc_ext": { "title": "التحقق من الهوية (KYC)", "subtitle": "يتم التحقق عبر Telegram.", "verify_telegram": "التحقق عبر Telegram", "verify_telegram_desc": "ابدأ العملية بمراسلة حسابنا الرسمي", "verify_btn": "التحقق عبر Telegram →", "pending_title": "التحقق في الانتظار", "stay_telegram": "ابق على تواصل عبر Telegram", "close": "إغلاق" },
            "app_ext": { "powered_by": "مدعوم من Taste AI", "new_badge": "جديد", "settings_label": "الإعدادات" },
            "coin_details": {"live_price": "السعر المباشر", "trade": "تداول في البورصة", "send": "إرسال", "deposit": "إيداع", "stats": "معلومات السوق والتقنية", "contract": "عنوان العقد (Jetton)", "view_chart": "الرسم البياني"},
            "manage_coins": {"title": "🪙 إدارة الأصول / إضافة عملة", "tab_manage": "إدارة وإخفاء العملات", "tab_add": "إضافة عملة مخصصة", "hide_hint": "يمكنك إخفاء العملات التي لا تريد رؤيتها في الصفحة الرئيسية للمحفظة.", "hidden": "مخفي", "shown": "مرئي", "add_desc": "الصق عنوان عقد TON Jetton الذي تريد إضافته:", "search": "بحث", "invalid_addr": "يرجى إدخال عنوان عقد TON Jetton صالح.", "confirm_add": "إضافة إلى المحفظة", "add_btn": "إضافة / إدارة العملات"}
        }
    },
    "zh": {
        "translation": {
            "drawer": { "ai_chef_menu": "TASTE AI 大厨 (食谱与卡路里)", "ecosystem": "生态系统", "socials": "社交媒体", "team": "团队", "jobs": "工作", "swap": "交换", "tokenomics": "代币经济学", "whitepaper": "白皮书", "blockchain": "区块链", "ai": "人工智能", "ai_chef": "AI大厨", "help": "帮助", "website": "网站", "legal": "法律", "settings": "设置" },
            ...
            "chef_banner": {
                ...
                "new_badge": "最新",
                "new_engine": "全新引擎",
                "desc": "选择冰箱食材，AI生成专属美食食谱与热量分析！",
                "start": "开始"
            },
            "chef_app": {
                "fridge_title": "我的冰箱与已选食材",
                "clear": "清空",
                "empty_hint": "尚未选择任何食材。请从下方选择或手动输入。",
                "custom_placeholder": "+ 输入其他食材（例如：牛油果、三文鱼）...",
                "add": "添加",
                "quick_presets": "快速食材预设",
                "chef_preferences": "大厨偏好设置",
                "cooking_time": "烹饪时间",
                "diet_type": "饮食与营养",
                "cuisine": "风味菜系",
                "create_recipe_btn": "✨ 生成专属美食食谱与热量分析",
                "generating": "👨‍🍳 大厨正在分析食材并计算卡路里...",
                "macro_dashboard": "营养成分与卡路里（每份）",
                "ingredients_title": "所需食材与配量",
                "instructions_title": "一步步烹饪步骤",
                "chef_tip_title": "👨‍🍳 大厨独家秘诀 (Pro Tip)",
                "new_recipe_btn": "🔄 重新生成食谱",
                "copied": "已复制！",
                "time_quick": "15-20分钟 (快捷)",
                "time_medium": "30分钟 (中等)",
                "time_gourmet": "45+分钟 (米其林慢煮)",
                "diet_all": "全部 / 标准",
                "diet_high_protein": "高蛋白增肌",
                "diet_low_calorie": "低卡减脂 / 轻食",
                "diet_keto": "生酮低碳",
                "diet_vegan": "纯素食",
                "cuisine_mediterranean": "地中海风味",
                "cuisine_turkish": "土耳其传统风味",
                "cuisine_italian": "意式风情",
                "cuisine_asian": "亚洲料理",
                "cuisine_world": "世界融合美食",
                "calories": "卡路里",
                "protein": "蛋白质",
                "carbs": "碳水化合物",
                "fat": "脂肪",
            ...
            "profile_ext": { "title": "个人资料", "your_level": "您的等级", "tai_balance": "TAI 余额", "total_withdrawal": "总提现", "subscription": "您的订阅", "free": "免费", "free_desc": "可以提现 TAI 并赚取奖励", "upgrade": "升级", "privacy": "隐私政策", "logout": "退出登录", "next_level": "下一个:", "member_since": "会员自:", "level_apprentice": "学徒", "level_journeyman": "熟练工", "level_master": "大师", "level_chef": "厨师", "level_head_chef": "主厨" },
            "swap_screen": { "title": "购买 TAI", "subtitle": "通过兑换代币赚取 TAI", "select_pair": "选择交易对", "sell_token": "卖出代币", "buy_token": "买入代币", "trade_on": "交易于", "swap_info": "兑换在外部 DEX 上进行。连接您的钱包并确认。", "swap_btn": "购买 TAI", "external_redirect": "此交易将您重定向到外部平台" },
            "kyc_ext": { "title": "身份验证 (KYC)", "subtitle": "验证通过 Telegram 进行。", "verify_telegram": "通过 Telegram 验证", "verify_telegram_desc": "给我们的官方账户发消息开始流程", "verify_btn": "通过 Telegram 验证", "pending_title": "验证待定", "stay_telegram": "通过 Telegram 保持联系", "close": "关闭" },
            "app_ext": { "powered_by": "由 Taste AI 提供支持", "new_badge": "新", "settings_label": "设置" },
            "coin_details": {"live_price": "实时价格", "trade": "在交易所交易", "send": "发送", "deposit": "充值", "stats": "市场与技术信息", "contract": "合约地址 (Jetton)", "view_chart": "图表"},
            "manage_coins": {"title": "🪙 管理资产 / 添加代币", "tab_manage": "管理与隐藏代币", "tab_add": "添加自定义代币", "hide_hint": "您可以隐藏不想在钱包主页上看到的代币。", "hidden": "已隐藏", "shown": "可见", "add_desc": "粘贴您要添加的 TON Jetton 合约地址：", "search": "查找", "invalid_addr": "请输入有效的 TON Jetton 合约地址。", "confirm_add": "添加到钱包", "add_btn": "添加 / 管理代币"}
        }
    }
};;
