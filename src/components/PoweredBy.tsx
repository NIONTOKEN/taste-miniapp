...
const VercelLogo = () => (
    <svg viewBox="0 0 24 24" style={{ width: '100%', height: '100%', padding: '3px', boxSizing: 'border-box', background: '#000', borderRadius: '6px' }} fill="white">
...
export function PoweredBy() {
    ...
    const tools: Tool[] = [
        ...
        { name: 'Vercel', color: '#ffffff', category: 'Tech', url: 'https://vercel.com', Logo: VercelLogo, badge: 'Hosting' },
        ...
        { name: 'GitHub', color: '#f0f6fc', category: 'Socials', url: 'https://github.com/NIONTOKEN/taste-miniapp', Logo: GithubLogo, badge: '⭐ OSS' },
